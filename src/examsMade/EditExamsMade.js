...
export default function EditExamsMade() {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    try{
      if (examsMade.employee.employee_id === null || examsMade.exam.exam_id === null) {
      ...
      <div className="row">
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
          ...
          <DatePicker
            ...
            placeholder="Mes dd, yyyy"
            onChange={(e) => onInputChangeExamsMadeDate(e)}
            value={new Date(examsMade.examsMade_date)}
          />
